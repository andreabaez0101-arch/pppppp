  ...
  return (
    <>
      ...
      >
        ...
        {/* Total */}
        <span className="font-mono text-base font-bold text-primary">${total}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl px-4 py-1.5 text-xs font-bold text-background transition-all duration-150 hover:brightness-110 active:scale-95"
            style={{ background: "oklch(0.72 0.22 195)" }}
          >
